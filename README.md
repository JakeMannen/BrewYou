...
4. **Change Theme**: Select your preferred appearance in **Settings ➔ Appearance** between _Modern Amber (Dark)_, _Pilsner Clean (Light)_, _Obsidian Stout (Ember)_, or _System Match_.
