...
public class Recipe
{
    ...
    public ICollection<RecipeMashStep> MashSteps { get; set; } = new List<RecipeMashStep>();
    public ICollection<RecipeFermentationStep> FermentationSteps { get; set; } = new List<RecipeFermentationStep>();
}